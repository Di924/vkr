<?php
    ...
    // Users class
    require_once BASE_PATH . '/model/Dashboard.php';
    ...
    $rows = $db->arraybuilder()->paginate('dashboard', $page, $select);
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="page-header">Досктки задач</h1>
        </div>
        <div class="col-lg-6">
    ...
    <div class="well text-center filter-form">
        <form class="form form-inline" action="">
            ...
            <select name="filter_col" class="form-control">
                <?php
                foreach ($dashboard->setOrderingValues() as $opt_value => $opt_name):
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php 
                    if ($row['image']) {
                        $image_url = '../img/dashboard/'.$row['image'];
                ...
                <td>
                    <a href="edit.php?dashboard=<?php echo $row['id']; ?>&operation=edit&dashboard_foto=<?php echo $row['image']; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i></a>
                    <a href="delete.php?del_id=<?php echo $row['id']; ?>&dashboard_name=<?php echo $row['name']; ?>" class="btn btn-danger delete_btn"><i class="glyphicon glyphicon-trash"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>

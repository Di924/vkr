...
function form_generator($title, $class, $formName)
{
    require_once(BASE_PATH . '/includes/header.php');
    
    echo '<div  class="container bg-light-50">
			<div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
            ...
            <form class="' . $class . '" id="' . $formName . '" action="" method="POST" enctype="multipart/form-data">';
            
    include_once(BASE_PATH . '/views/forms/' . $formName . '.php'); 
